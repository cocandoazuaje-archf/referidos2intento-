  ...
  angular.mock.TzDate = function (offset, timestamp) {
    ...
    if (self.toISOString) {
      self.toISOString = function () {
        return (
          padNumberInMock(self.origDate.getUTCFullYear(), 4) +
          "-" +
 ...
 */
  ...
  function createHttpBackendMock($rootScope, $timeout, $delegate, $browser) {
    ...
    $httpBackend.when = function (method, url, data, headers, keys) {
      var definition = new MockHttpExpectation(
          method,
          url,
          data,
          headers,
    ...
    $httpBackend.expect = function (method, url, data, headers, keys) {
      var expectation = new MockHttpExpectation(
          method,
          url,
          data,
          headers,
  ...
  function MockHttpExpectation(method, url, data, headers, keys) {
    ...
    function compareUrl(u) {
      return (
        url.slice(0, url.indexOf("?")) === u.slice(0, u.indexOf("?")) &&
  ...
  angular
    ...
    .config([
      ...
      function ($provide, $compileProvider) {
        ...
        $provide.decorator(
          "$controller",
          createControllerDecorator($compileProvider),
        );
      },
    ]);
  ...
  (function (jasmineOrMocha) {
    ...
    module.sharedInjector = function () {
      if (!(module.$$beforeAllHook && module.$$afterAllHook)) {
        throw Error(
          "sharedInjector() cannot be used unless your test runner defines beforeAll/afterAll",
        );
      }
        ...
        /** @this */ function () {
          if (injectorState.shared) {
            injectorState.sharedError = Error(
              "sharedInjector() cannot be called inside a context that has already called sharedInjector()",
            );
    ...
    module.$$cleanup = function () {
      ...
      if (injector) {
        ...
        if (
          rootNode &&
          (!originalRootElement || rootNode !== originalRootElement[0])
        ) {
    ...
    var ErrorAddingDeclarationLocationStack =
      function ErrorAddingDeclarationLocationStack(e, errorForStack) {
