  ...
  var Keycloak = function (config) {
    ...
    function parseCallback(url) {
      ...
      if (
        ...
        oauth.state &&
        oauth.state == sessionState.state
      ) {
    ...
    function setupCheckLoginIframe() {
      ...
      var src =
        getRealmUrl() +
        "/protocol/openid-connect/login-status-iframe.html?client_id=" +
        encodeURIComponent(kc.clientId) +
        "&origin=" +
        getOrigin();
    ...
    function checkLoginIframe() {
      ...
      if (loginIframe.iframe && loginIframe.iframeOrigin) {
        ...
        loginIframe.iframe.contentWindow.postMessage(
          JSON.stringify(msg),
          origin,
        );
      } else {
