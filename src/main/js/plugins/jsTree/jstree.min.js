      ...
      (a.jstree.core.prototype = {
        ...
        move_node: function (c, d, e, f, g, h) {
          ...
          if (c.parent === m.id) {
            ...
            for (
              ...
              this._model.data[m.parents[r]].children_d =
                this._model.data[m.parents[r]].children_d.concat(q);
        ...
        copy_node: function (c, d, e, f, g, h) {
          ...
          for (
            ...
            this._model.data[q.parents[m]].children_d =
              this._model.data[q.parents[m]].children_d.concat(k);
                  ...
                  : c === !0
                    ...
                    : -1 === c.indexOf("/") && -1 === c.indexOf(".")
                      ? (f.removeClass(g).css("background", ""),
                        f
                          .addClass(c + " jstree-themeicon-custom")
                          .attr("rel", c),
                        g === !1 && this.show_icon(b))
                      : (f.removeClass(g).css("background", ""),
                        f
      ...
      (function (a) {
        ...
        a.vakata.dnd = {
          ...
          _scroll: function (c) {
            ...
            if (!b.scroll_i)
              return (
                (b.scroll_i = setInterval(a.vakata.dnd._scroll, 100)),
                !1
              );
            if (c === !0) return !1;
