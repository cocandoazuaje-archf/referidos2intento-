 ...
 */
public class SucursalesJpaController1 implements Serializable {

  private transient EntityManager em;
  private String valAnError = "An error occurred attempting to roll back the transaction.";

  public SucursalesJpaController1(
      UserTransaction utx,
  ...
  public void edit(Sucursales sucursales)
    ...
    try {
      ...
      continuar2(ejecutivosCollectionNew, ejecutivosCollectionOld, sucursales);
    } catch (Exception ex) {
      try {
      } catch (Exception re) {
        throw new RollbackFailureException(valAnError, re);
  ...
  private void continuar(
      ...
      List<String> illegalOrphanMessages) throws IllegalOrphanException {
