...
function TestSupport() {
  ...
  this.wadlURL = "";
  this.wadlErr =
    "Cannot access WADL. Please restart your RESTful application, and refresh this page or provide the URL here. This may be caused by the REST implementation not providing the WADL file automatically (such as JBoss RESTEasy). In that case you have to pregenerate it manually or switch to Jersey libraries.";
...
TestSupport.prototype = {
  ...
  initFromWadl: function () {
    ...
    if (wDoc != null) {
      ...
      this.updatepage(
        "content",
        "<span class=bld>Help Page</span><br/><br/><p>Cannot access WADL. Please restart your REST application, and refresh this page. This may be caused by the REST implementation not providing the WADL file automatically (such as JBoss RESTEasy). In that case you have to pregenerate it manually or switch to Jersey libraries.</p><p>If you still see this error and if you are accessing this page using Firefox with Firebug plugin, then<br/>you need to disable firebug for local files. That is from Firefox menubar, check <br/>Tools > Firebug > Disable Firebug for Local Files</p>",
      );
    }
  },
  ...
  concatPath: function (url, pathElem) {
    ...
    if (url.substring(ndx - 1) == "/") {
      for (; ndx >= 0; ndx--) {
        if (url.substring(ndx - 2, ndx - 1) != "/") break;
      }
    ...
    if (pathElem.substring(ndx, ndx + 1) == "/") {
      for (; ndx < pathElem.length; ndx++) {
        if (pathElem.substring(ndx, ndx + 1) != "/") break;
      }
  ...
  getElementsByTagName: function (parent, name) {
    ...
    if (parent != null && name != null) {
      ...
      for (var i = 0; i < childs.length; i++) {
        ...
        if (
          name == nodeName ||
          nodeName.indexOf(":" + name, nodeName.length - name.length - 1) !== -1
        ) {
          results.push(child);
        }
      }
  ...
  getMethodMimeTypeCombo: function (resource) {
    ...
    var str =
      '<table border=0><tbody><tr><td valign="top"><span id="j_id14"><label for="methodSel" class="LblLev2Txt_sun4">' +
      "<span>Choose method to test: </span></label></span></td>";
    str +=
      "<td><span id=j_id14><select id='methodSel' class=MnuJmp_sun4 name='methodSel' onchange='javascript:ts.changeMethod();'>";
    for (var j = 0; j < methods.length; j++) {
      ...
      if (mediaType == null) mediaType = this.wdr.getDefaultMime();
      ...
      for (var k = 0; k < mimeTypes.length; k++) {
        ...
        if (mName == "GET")
          str +=
            "  <option class=MnuJmpOpt_sun4 value='" +
            dispName +
            "[" +
            j +
            "]' selected>" +
    ...
    str +=
      "</select></span></td><td width=46/><td><a class='Btn1_sun4 Btn1Hov_sun4' onclick='ts.testResource()'>Test</a></td></tr></tbody></table>";
    return str;
  },
  ...
  doShowContent: function (uri) {
    ...
    if (r != null) {
      ...
      this.doShowDynamicResource(
        uri,
        this.wdr.getDefaultMethod(),
        this.wdr.getDefaultMime(),
      );
    }
  },
  ...
  getPath: function (n, pathVal) {
    if (n.parentNode == null || n.attributes.getNamedItem("path") == null) {
      if (pathVal == null || pathVal == "") return "";
      else return pathVal;
    } else {
  ...
  doShowDynamicResource: function (uri, mName, mediaType) {
    ...
    paramNumber = 1;
    var qmName = "";
    if (mediaType != null) qmName = qmName + "(" + mediaType + ")";
    else mediaType = this.getDefaultMime();
    this.showBreadCrumbs(uri);
    var req = this.getDisplayUri(uri);
    var str =
      '<br/><table border=0><tbody><tr><td valign="top"><span id="j_id14"><label for="methodSel" class="LblLev2Txt_sun4">' +
      "<span>Choose method to test: </span></label></span></td>";
    str +=
      "<td><span id=j_id14><select id='methodSel' class=MnuJmp_sun4 name='methodSel' onchange='javascript:ts.changeMethod();'>";
    ...
    str += "</select></span></td>";
    str +=
      '<td valign="top"><span id="j_id14"><label for="methodSel" style="padding-left: 6px;" class="LblLev2Txt_sun4">' +
      "<span>MIME: </span></label></span></td>";
    str +=
      "<td><span id=j_id14><select id='mimeSel' class=MnuJmp_sun4 name='mimeSel' onchange='javascript:ts.changeMimeType();'>";
    str +=
      "  <option class=MnuJmpOpt_sun4 value='application/xml'>application/xml</option>";
    str +=
      "  <option class=MnuJmpOpt_sun4 value='application/json'>application/json</option>";
    str += "  <option class=MnuJmpOpt_sun4 value='text/xml'>text/xml</option>";
    str +=
      "  <option class=MnuJmpOpt_sun4 value='text/plain'>text/plain</option>";
    str +=
      "  <option class=MnuJmpOpt_sun4 value='text/html'>text/html</option>";
    str += "  <option class=MnuJmpOpt_sun4 value='image/*'>image/*</option>";
    str += "</select></span></td>";
    str += "<td width=30/>";
    str +=
      "<td><span id=j_id14><a class='Btn2_sun4 Btn1Hov_sun4' onclick='ts.addParam()'>Add Parameter</a>";
    str +=
      "</span></td><td><a class='Btn1_sun4 Btn1Hov_sun4' onclick='ts.testResource()'>Test</a></td></tr></tbody></table><br/>";
    ...
    var uriLink =
      "<a id='" +
      req +
      "' class=Hyp_sun4 href=javascript:ts.doShowContent('" +
      req +
      "') >" +
      this.getDisplayURL(disp, 80) +
      "</a>";
    this.updatepage(
      "request",
      "<span class=bld>Resource:</span> " +
        uriLink +
        ' <br/>(<a href="' +
        req +
        '" class=Hyp_sun4 target="_blank"><span>' +
        this.getDisplayURL(req, 90) +
        "</span></a>)",
    );
  },
  ...
  doShowStaticResource: function (uri, r) {
    ...
    this.updatepage(
      "testaction",
      "<br/>" + this.getMethodMimeTypeCombo(r) + "<br/>",
    );
  ...
  getFormRep: function (req, uri, mName, mediaType) {
    if (mName == null || mName == "undefined") mName = this.getDefaultMethod();
    if (mediaType == null || mediaType == "undefined")
      mediaType = this.getDefaultMime();
    var str = "<div id='formSubmittal'>";
    str +=
      "<form action='javascript:ts.dummyMethod()' method=" +
      mName +
      " id='form1' name='form1'>";
    ...
    str +=
      "<input id='methodName' name='methodName' value='" +
      mName +
      "' type='hidden'>";
    str +=
      "<input id='mimeType' name='mimeType' value='" +
      mediaType +
      "' type='hidden'>";
    str +=
      "<input id='test' name='test' style='display:none' value='' type='submit' onchange='ts.testResource();'>";
    str += "</form>";
    str += "</div>";
    return str;
  },
    ...
    for (var i in paths) {
      ...
      for (var j in compositeIds) {
        ...
        if (compositeId != null && compositeId.indexOf("{") > -1) {
          ...
          paramRep +=
            '<tr><td valign="top"><span id="j_id14"><label for="tparams" class="LblLev2Txt_sun4">';
          paramRep += "<span>" + pname + ": </span></label></span></td>";
          paramRep +=
            '<td><span id="j_id14"><input id=tparams name="' +
            pname +
            '" type=text value="" size=40 title="' +
            pname +
            '" class="TxtFld_sun4 TxtFldVld_sun4"/></span></td></tr>';
        }
      }
    }
    if (paramRep != "") {
      paramRep =
        "<table border=0><tbody><tr>" + paramRep + "</tr></tbody></table>";
    }
    return paramRep;
  },
  ...
  addParam: function () {
    var str =
      '<tr><td valign="top"><span id="j_id14"><label for="newParamNames" class="LblLev2Txt_sun4">';
    str += "<span>param" + paramNumber + ": </span></label></span></td>";
    str +=
      '<td><span id="j_id14"><input id=newParamNames name="param' +
      paramNumber +
    ...
    str +=
      '<tr><td valign="top"><span id="j_id14"><label for="newParamValues" class="LblLev2Txt_sun4">';
    str += "<span>value" + paramNumber + ": </span></label></span></td>";
    str +=
      '<td><span id="j_id14"><input id=newParamValues name="param' +
      paramNumber +
    ...
    if (prevParam.indexOf("Additional parameters") == -1) {
      str =
        '<tr><td valign="top"><span id="j_id14"><label for="dummy" class="LblLev2Txt_sun4">' +
  ...
  showBreadCrumbs: function (uri) {
    ...
    var str =
      "<a class=Hyp_sun4 href=javascript:ts.clearAll() >" +
      ts.projectName +
      "</a>";
    var req = this.getDisplayUri(uri);
    ...
    for (var i = 0; i < paths.length - 1; i++) {
      ...
      str +=
        "&nbsp;&gt; <a id='" +
        currPath +
        "' class=Hyp_sun4 href=javascript:" +
        jsmethod +
        " >" +
        pname +
        "</a>";
  ...
  getParamRep: function (req, mName) {
      ...
      for (var i = 0; i < req.length; i++) {
        ...
        if (params != null) {
          for (var j = 0; j < params.length; j++) {
            var param = params[j];
            if (param.nodeName == null || param.nodeName != "param") continue;
            ...
            if (type == "template") paramsId = "tparams";
            else if (type == "matrix") paramsId = "mparams";
            str +=
              '<tr><td valign="top"><span id="j_id14"><label for="' +
              paramsId +
              '" class="LblLev2Txt_sun4">' +
              "<span>" +
              pname +
              "</span></label></span></td>" +
              '<td><span id="j_id14"><input type="text" id="' +
              paramsId +
              '" name="' +
              pname +
              '" value="' +
    ...
    if (mName == "PUT" || mName == "POST") {
      str +=
        '<tr><td valign="top"><span id="j_id14"><label for="blobParam" class="LblLev2Txt_sun4">' +
  ...
  testResource: function () {
    ...
    if (qparams != null) {
      if (qparams.length == undefined) {
        ...
        for (var j = 0; j < len; j++) {
          ...
          else p += escape(param.name) + "=" + escape(param.value) + "&";
        }
      }
    }
    ...
    if (newParamNames != null) {
      if (newParamNames.length == undefined) {
        ...
        for (var j = 0; j < len; j++) {
          ...
          else p += escape(paramName) + "=" + escape(paramValue) + "&";
        }
      }
    }
    ...
    if (method == "POST" || method == "PUT") {
      ...
      if (params != null) paramLength = params.length;
    } else if (method == "GET" || method == "DELETE") {
      paramLength = 0;
    }
    var req;
    if (ts.isURL(path)) req = path;
    else req = baseURL + escape(path);
    ...
    if (method == "GET" && p.length > 0) req += "?" + p;
    ...
    if (req.indexOf("?") != -1) req = req + "&timestamp=" + timestamp;
    else req = req + "?timestamp=" + timestamp;
  ...
  createIFrameForUrl: function (url) {
    var c =
      '<iframe id="iFrame_" src="' +
      url +
      '" class="frame" width="' +
      ts.iframeWidth +
      '" align="left">' +
      '<p>See <a class=Hyp_sun4 href="' +
      url +
      '">"' +
      url +
      '"</a>.</p>' +
  ...
  monitor: function (method, xmlHttpReq, param) {
    ...
    var s =
      ...
      "\n\n<br/><br/>Time-Stamp: " +
      " " +
      xmlHttpReq.getResponseHeader("Date") +
      "";
    var prevs = "";
  ...
  updateContent: function (content) {
    var showRaw = true;
    var cErr =
      "Content may not have Container-Containee Relationship. See Raw View for content.";
    if (content != null && content != undefined) {
      try {
        ...
        if (content.indexOf("<?xml ") != -1 || content.indexOf('{"') != -1) {
        ...
        this.updatepage(
          "result",
          this.createTabs(tableContent, rawContent, showRaw),
        );
        if (showRaw) {
          if (ts.isURL(content)) this.currentValidUrl = content;
          if (
            ...
            if (
              ...
              this.currentMimeType != "application/csv" &&
              this.currentMimeType != "text/plain"
            )
              this.updatepage(
                "rawContent",
                this.createIFrameForUrl(this.currentValidUrl),
              );
            else this.updatepage("rawContent", content);
          }
          this.showViews("raw");
        } else {
  ...
  createTabs: function (tableContent, rawContent, showRaw) {
    ...
    var structure = this.xhr.options(
      this.currentValidUrl,
      "application/vnd.sun.wadl+xml",
    );
    var subResources = this.getContainerTable(
      ts.wdr.evaluateWADLUpdate(this.currentValidUrl, structure),
    );
    if (subResources == null) subResources = "No Sub-Resources available.";
    var tabs =
      "<br/><span class=bld>Status:</span> " +
      this.currentXmlHttpReq.status +
      " (" +
      this.currentXmlHttpReq.statusText +
      ")<br/><br/>" +
    ...
    function printIndented(/*Node*/ node, /*int*/ indent) {
      if (node.nodeValue != null) {
        ...
        if (node.childNodes != null && node.childNodes.length > 0) {
          ...
          else prettyContent += getContent(node, false);
        }
      }
    }
      ...
      if (n.nodeValue == null) {
        ...
        if (n.nodeName == "#document") {
          ...
          if (start) {
            ...
            if (n.childNodes != null && n.childNodes.length > 0) c += "&gt;";
            else c += "/&gt;";
          } else {
            c += "&lt;/" + n.nodeName + "&gt;";
          }
    ...
    function breakLine2(line, len, indent) {
      ...
      if (indent.length + c.length > 100) {
        ...
        c =
          ...
          indent +
          "&nbsp;&nbsp;&nbsp;" +
          breakLine2(c.substring(len2), len, indent);
      }
      return c;
    }
  ...
  getTab: function (id, actived) {
    ...
    if (actived)
      return (
        '<td class="Tab1TblSelTd_sun4"><div title="Current Selection: Text Field" class="Tab1SelTxtNew_sun4"><a name="selectedTabAnchor" id="tab' +
        id +
        '"/>' +
        name +
        "</div></td>"
      ...
      if (id == "")
        return (
          '<td style="visibility: hidden;"><a href="javascript:ts.showViews(\'' +
          id +
          '\')" class="Tab1Lnk_sun4" id="tab' +
          id +
          '">' +
          name +
          "</a></td>"
        ...
        return (
          "<td><a href=\"javascript:ts.showViews('" +
          id +
          '\')" class="Tab1Lnk_sun4" id="tab' +
          id +
          '">' +
  ...
  getHeaderAsTable: function (xmlHttpReq) {
    ...
    for (var i = 0; i < rows.length; i++) {
      ...
      str2 +=
        '<tr><th align="left" scope="row" class="TblTdLyt_sun4" ><span id="j_id9"><span class="">' +
        name +
        "</span></span></th>";
      str2 +=
        '<td align="left" class="TblTdLyt_sun4" ><span id="j_id10"><span class="">' +
        val +
        "</span></span></td></tr>";
    }
    ...
    var str =
      '<table width="100%" cellspacing="0" cellpadding="0" border="0" class="Tbl_sun4">' +
      '<caption class="TblTtlTxt_sun4">' +
      this.getDisplayUri(req) +
      " (" +
      count +
      ")</caption>";
    str += "<tbody><tr>";
    for (i = 0; i < colNames.length; i++) {
      str +=
        '<th align="left" scope="col" class="TblColHdr_sun4"><span class="TblHdrTxt_sun4">' +
        colNames[i] +
        "</span></th>";
    }
    str += "</tr>";
  ...
  getContainerTable: function (content) {
    ...
    try {
      if (content.indexOf("<?xml ") != -1) {
        ...
        if (container == null || container.nodeName == "html") return null;
      }
      var colNames = new Array();
      colNames[0] = "ID";
      colNames[1] = "URI";
      ...
      colSizes[1] = "";
      var str2 = null;
      if (container != null) str2 = this.findUriFromXml(container);
      else str2 = this.findUriFromContent(content);
      if (str2 == null || str2 == "") return null;
      var req = this.currentValidUrl;
      if (req.indexOf("?") > 0) req = req.substring(0, req.indexOf("?"));
      var str =
        '<table width="100%" cellspacing="0" cellpadding="0" border="0" class="Tbl_sun4">' +
  ...
  getChildUriFromXml: function (refChild) {
    ...
    if (subChilds == null || subChilds.length == 0) return;
    var j = 0;
    for (j = 0; j < subChilds.length; j++) {
      var subChild = subChilds[j];
      if (subChild.nodeValue == null) {
        //DOM Elements only
        if (
          subChild.attributes != null &&
          subChild.attributes.length > 0 &&
  ...
  createRowForUriFromXml: function (refChild) {
    ...
    var id = "-";
    if (
      refChild.childNodes != null &&
      refChild.childNodes.length > 0 &&
    ...
    str +=
      "<a id='" +
      uri +
      "' href=javascript:ts.doShowContent('" +
      uri +
      "') >" +
      this.getDisplayURL(disp, 70) +
      "</a>";
    str +=
      "<br/>(<a href='" +
      subsUri +
      "' target='_blank'><span>" +
      this.getDisplayURL(uri, 70) +
      "</span></a>)";
    str += "</span></span></td></tr>";
    return str;
  },
  ...
  getSubstitutedUri: function (uri) {
    ...
    if (ndx > 0)
      subsUri =
        subsUri.substring(0, ndx) +
        "1" +
        subsUri.substring(subsUri.indexOf("}", ndx) + 1);
    return subsUri;
  },
  ...
  findUriFromContent: function (content) {
    ...
    if (cvl == -1) cvl = this.currentValidUrl.length;
    this.tcCount = 0;
  ...
  getDisplayUri: function (uri) {
    var disp = uri;
    if (disp.length > baseURL.length) disp = disp.substring(baseURL.length);
    return disp;
  },
  ...
  updatepage: function (id, str) {
    ...
    if (n != null) n.innerHTML = str;
  },

  getFormMimeType: function () {
    var resource = document.getElementById("mimeType");
    if (resource != null) return this.wdr.getMimeType(resource.value);
    else return this.wdr.getDefaultMime();
  },

  getFormMethod: function () {
    var resource = document.getElementById("methodName");
    if (resource != null) return this.wdr.getMethod(resource.value);
    else return this.wdr.getDefaultMethod();
  },
  ...
  debug: function (message) {
    ...
    if (dbgComp == null) {
      ...
      var tab =
        "width: 20px; border-right: #2574B7 1px solid; border-top: #2574B7 1px solid; border-left: #2574B7 1px solid; border-bottom: #2574B7 1px solid; color: #000000; text-align: center;";
      var addActionStr =
        '<div style="' +
        tab +
        '"><a style="text-decoration: none" href="javascript:ts.closeDebug()"><span style="color: red">X</span></a></div>';
      dbgComp.innerHTML =
        '<table><tr><td><span style="color: blue">Rest Debug Window</span></td><td>' +
        addActionStr +
        "</td></tr></table><br/>";
    }
    ...
    dbgComp.innerHTML =
      s +
      '<span style="color: red">rest debug(' +
      dateStr +
      "): </span>" +
      message +
      "<br/>";
...
WADLParser.prototype = {
  getWadlDocument: function (wadlURL) {
    ...
    if (
      wadlData == undefined ||
      wadlData == "" ||
      wadlData.indexOf("RequestFailed -->") != -1
    ) {
      ...
      if (app != null) {
        ...
        if (rChilds != null && rChilds.length > 0) {
          ...
          for (var i = 0; i < rChilds.length; i++) {
            ...
            wadlData = ts.xhr.options(
              ts.concatPath(base, path),
              "application/vnd.sun.wadl+xml",
            );
          ...
          if (wDocArr.length > 0) {
            wDoc = wDocArr[0];
            resources = ts.getElementsByTagName(
              wDoc.documentElement,
              "resources",
            )[0];
            for (var i = 1; i < wDocArr.length; i++) {
              var rs = ts.getElementsByTagName(
                wDocArr[i].documentElement,
                "resources",
              )[0];
  ...
  updateMenu: function (wUrl, wDoc) {
    ...
    ts.updatepage(
      "subheader",
      '<br/><span class=MstLbl_sun4>WADL : </span><a class=MstLnk_sun4 href=\"' +
        wUrl +
        '\">' +
        wUrl +
        "</a>",
  ...
  createTree: function (wadlDoc) {
    ...
    if (app != null) {
      ...
      ts.projectName = this.projectNameFromUrl(
        rs.attributes.getNamedItem("base").nodeValue,
      );
      var resources = new category(
        rs,
  ...
  projectNameFromUrl: function (url_) {
    ...
    if (begin != -1) url = url.substring(begin, url.length);
    var index = url.indexOf("/", 1);
    if (url.length > 1 && index != -1) url = url.substring(1, index);
    return url;
  },
  ...
  prependSeperator: function (cName) {
    if (cName != null) {
      if (cName.substring(0, 1) != "/") cName = "/" + cName;
    }
    return cName;
  },
    ...
    try {
      ...
      if (resources != null) {
        for (i = 0; i < resources.length; i++) {
          ...
          var url = "";
          if (
            baseURL.substring(baseURL.length - 1, baseURL.length) != "/" &&
            path.substring(0, 1) != "/"
          )
            url = baseURL + "/" + path;
  ...
  getAllResourcesFromWadl: function (content) {
    try {
      ...
      if (container != null) return this.findResourcesFromWadl(container);
    } catch (e) {
      ts.debug(
        "getAllResourcesFromWadl() err name: [" +
          e.name +
          "] message: [" +
          e.message +
          "]",
  ...
  showCategory: function (category) {
    ...
    else categoryChildNodes.display = "block";
  ...
  updateTree: function (catId) {
    if (catId == this.getTopCategoryId()) {
      //return if top level
      this.showTopCategory();
      return;
    }
      ...
      if (rep != null) {
        for (var i = 0; i < rep.length; i++) {
          if (rep[i].attributes.length > 0) {
            ...
            if (att != null) mediaType += att.nodeValue + ",";
          }
        }
      }
    }
        ...
        if (rlist != null && rlist.length > 0) {
          for (var i = 0; i < rlist.length; i++) {
            ...
            if (rr.nodeValue == null && rr.nodeName == "resource") {
              ...
              if (
                ts.wdr.trimSeperator(path.nodeValue) == ts.wdr.trimSeperator(u)
              ) {
                return rr;
              }
            }
  ...
  getMimeType: function (mime) {
    if (mime != null) {
      ...
      } else return mime.substring(i + 1, mime.length - 1);
    } else return getDefaultMime();
  },

  getMethod: function (method) {
    if (method != null) {
      var i = method.indexOf("(");
      if (i == -1) return method;
      else return method.substring(0, i);
    } else return this.getDefaultMethod();
  },
  ...
  getChildrenAsItems: function (xmlStr) {
    ...
    try {
      ...
      ts.debug(
        "getChildrenAsItems()->loadXml() err name: [" +
          e.name +
          "] message: [" +
          e.message +
          "]",
...
category.prototype = {
  write: function () {
    var categoryString =
      '<span id="nodeSel' + this.id + '" class="category TreeContent_sun4"';
    if (this.uri != baseURL) {
      categoryString +=
        '><img src="cg.gif" id="I1' +
        this.id +
        '" onClick="ts.wdr.showCategory(\'' +
        this.id +
        "')\">";
      categoryString += '<img src="collapse.gif" id="I' + this.id + '">';
      categoryString +=
        "<div class='item2'><a class=Hyp_sun4 href=javascript:ts.doShowContentForId('" +
        this.ndx +
        "') >" +
        this.text +
        "</a></div>";
      ...
      categoryString +=
        '><img src="cg.gif" id="I1' +
        this.id +
        '" onClick="ts.wdr.updateTree(\'' +
        this.id +
        "')\">";
      categoryString += '<img src="app.gif" id="I' + this.id + '">';
      categoryString +=
        "<div class='item2'><a class=Hyp_sun4 href=javascript:ts.clearAll() >" +
        this.text +
        "</a></div>";
    }
    categoryString += "</span>";
    ...
    for (var j = 0; j < numitems; j++) categoryString += this.items[j].write();
    categoryString += "</span>";
...
item.prototype = {
  write: function () {
    var itemString =
      '<span class="category TreeContent_sun4"><img src="cc.gif" border="0">';

    itemString += '<img src="item.gif" border="0">';
    if (this.uri != null)
      itemString +=
        "<div class=item1><a class=Hyp_sun4 href=javascript:ts.doShowContentForId('" +
        this.ndx +
        "') >" +
        this.text +
        "</a></div>";
    else itemString += this.text;
    itemString += "</span>";
    return itemString;
  },
};
...
XHR.prototype = {
  ...
  connect: function (method, url, mimeType, paramLen, async) {
    ...
    try {
      ...
      ts.debug(
        "connect(): Error: XMLHttpRequest.open failed for: " +
          url +
          " Error name: " +
          e.name +
          " Error message: " +
    ...
    if (toggleHeadersBlock && toggleHeadersBlock.cache) {
      ...
      if (req_hdr.length > 0) {
        xmlHttpReq.setRequestHeader(
          req_hdr,
          ts.getRequestHeader("req_hdr_val_1"),
        );
      }
      ...
      if (req_hdr.length > 0) {
        xmlHttpReq.setRequestHeader(
          req_hdr,
          ts.getRequestHeader("req_hdr_val_2"),
        );
      }
      ...
      if (req_hdr.length > 0) {
        xmlHttpReq.setRequestHeader(
          req_hdr,
          ts.getRequestHeader("req_hdr_val_3"),
        );
      }
      ...
      if (req_hdr.length > 0) {
        xmlHttpReq.setRequestHeader(
          req_hdr,
          ts.getRequestHeader("req_hdr_val_4"),
        );
      }
      ...
      if (req_hdr.length > 0) {
        xmlHttpReq.setRequestHeader(
          req_hdr,
          ts.getRequestHeader("req_hdr_val_5"),
        );
      }
    }
  ...
  httpRequest: function (method, url, mime, content, monitor) {
    var len = 0;
    if (content != undefined && content != null) len = content.length;
    ...
    try {
      ...
      if (this.isResponseReady(method, xmlHttpReq, content, monitor)) {
        ...
        if (
          ...
          var err =
            method +
            " RequestFailed RequestFailed --> Status: (" +
            xmlHttpReq.status +
            ")\n<br/>" +
            "Response: {<br/>" +
      ...
      ts.debug(
        "httpRetrieve(): Caught Exception; name: [" +
          e.name +
          "] message: [" +
          e.message +
          "]",
